...
{
    public partial class RowMaterialPODetailForm : Form
    {
        public RowMaterialPODetailForm()
        {
            InitializeComponent();
            init();
        }
        ...
        private void init()
        {
            this.toolTip.SetToolTip(this.leftArrow, "原材料PO状态前移");
            this.toolTip.SetToolTip(this.rightArrow, "原材料PO状态后移");
        }
